...
<a href="panierf.php"><i class="fas fa-apple-alt"></i> Fruits</a>
          ...
          <div class="menu_par">
            ...
            <?php 
                ...
                if(empty($ids)){
                      ...
                      $products = $DB->query('SELECT * FROM Fruits WHERE id IN ('.implode(',',$ids).')');
                  }
      ...
      <div class="pnier">
            ...
            <div class="inf1">
            <img class="imr" src="img/repas/Fruits/<?= $products->id; ?>.jpg">
            <h1><?= $products->nom; ?></h1>
            ...
            <span class="action">
            <a href="panierf.php?del=<?= $products->id; ?>" class="del"><i class="del fas fa-trash-alt"></i></a>
                    </span>
            </div>
        <?php endforeach; ?>

    <div style="border:1px solid #fff">
      <div class="rowtotal"> TOTAL : <?= number_format($panierf->total(),2,',',' '); ?> DH
      ...
      paypal.Buttons({
        ...
        createOrder: function(data, actions) {
          return actions.order.create({
            purchase_units: [{"amount":{"currency_code":"USD","value":<?= number_format($panierf->total(),2,'.',' '); ?>}}]
          });
        },
