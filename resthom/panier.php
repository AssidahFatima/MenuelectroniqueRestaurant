...
<a href="panierf.php"><i class="fas fa-apple-alt"></i> Fruits</a>
      ...
      <div class="pnier">
            ...
            <span class="action">
            <a href="panier.php?del=<?= $products->id; ?>" class="del"><i class="del fas fa-trash-alt"></i></a>
                    </span>
            </div>
        <?php endforeach; ?>

    <div style="border:1px solid #fff">
      <div class="rowtotal"> TOTAL : <?= number_format($panier->total(),2,',',' '); ?> DH
      ...
      paypal.Buttons({
        ...
        createOrder: function(data, actions) {
          return actions.order.create({
            purchase_units: [{"amount":{"currency_code":"USD","value":<?= number_format($panier->total(),2,'.',' '); ?>}}]
          });
        },
