    ...
    <div class="head">
        ...
        <div class="nav">
            ...
            <a href="admin.php"><img id="im1" src="img/food.png" style="cursor: pointer;"></a>
                ...
                <a href="#"><li id="li5"> Boîte de réception  </li></a>
...
<div class="asid" style="float:left; border: 1px solid #bfbcbc4a;">
        ...
        <div class="impri"> <i class="fas fa-print"></i> <span><a href="impremant.php" style="color:#fff;text-decoration: none;">Imprimer</a></span></div>
...
<div class="art" style="float: left;width: 69.8%;"> 
      ...
      <iframe src="recepartition.php" width="99%" height="90%"></iframe>
